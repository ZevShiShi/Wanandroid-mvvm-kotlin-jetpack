...
class SysAdapter : BaseQuickAdapter<SysEntity, BaseViewHolder>(R.layout.item_system_layout, null) {

    override fun convert(holder: BaseViewHolder, item: SysEntity) {
        ...
        holder.getView<RecyclerView>(R.id.rvSys).run {
            ...
            adapter = SysChildAdapter(item.children).apply {
