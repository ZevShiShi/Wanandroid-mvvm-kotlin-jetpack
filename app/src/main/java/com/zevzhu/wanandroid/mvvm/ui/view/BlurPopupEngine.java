package com.zevzhu.wanandroid.mvvm.ui.view;
...
//                        })
    ...
    private Bitmap blur(Bitmap bkg, View view) {
        int bkgWidth = bkg == null ? 1 : bkg.getWidth();
        int bkgHeight = bkg == null ? 1 : bkg.getHeight();
        ...
        double height = Math.ceil(bkgHeight / mDownScaleFactor);
        double width = Math.ceil((bkgWidth * height
                / bkgHeight));
...
//                    clipRect.width(), clipRect.height(), null, false);
            mBackground = Bitmap.createScaledBitmap(mBackground, clipRect.width(), clipRect.height(), false);
